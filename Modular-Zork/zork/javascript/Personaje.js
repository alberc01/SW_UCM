...
var Personaje= function(id,vida,nombre,fuerza,hibilidad,inventario,imagen,x,y,w,h){ //Esta cruzado con partida por eso sabemos su posicion
	...
	this.inicializa=function(){
		this.id=id;
		this.inventario= [];
		this.inventarioConsumidos= new Array();
		this.vidaMax=vida;
		this.vidaAct=vida;
		this.nombre=nombre;
		this.fuerza=fuerza;
	...
	this.setVidaMax=function(vida){
		this.vidaMax=parseInt(vida);
	}
	this.setFuerza=function(fuerza){
		this.fuerza=parseInt(fuerza);
	}
	this.setVidaAct=function(vida){
		this.vidaAct=parseInt(vida);
	}
	this.setHabilidad=function(habil){
		this.habilidad=parseInt(habil);
	}
	this.setTraspa=function(traspa){
		this.trasparencia=parseInt(traspa);
	}
	...
	this.consumePocion=function(consumible){
		...
		this.inventarioConsumidos.push(consumible.getId());
	...
	this.datosGuarda=function(){
		var datos={
			"inventarioConsumidos":this.inventarioConsumidos,
