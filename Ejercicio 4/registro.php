...
<div id="contenedor">
	...
	<div id="contenido">
		...
		<p><label>Correo:</label> <input required type="email" name="email" id="campoEmail" />
			<span id="valido">&#x2714</span><!-- puedes añadir cosas aquí -->
            <span id="invalido">&#x26a0</span>
        </p>
		<p><label>User:</label> <input required type="text" name="username" id="campoUser" />
            <span id="usuValido">&#x2714</span><!-- puedes añadir cosas aquí -->
            <span id="usuNoValido">&#x26a0</span><!-- puedes añadir cosas aquí --> </p>
